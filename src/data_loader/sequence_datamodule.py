...
from torch.utils.data import Dataset, Subset #...We want to use this to directly convert the data into torch format.

from data.targets import TargetCreator #...We probably don't neeed this part
from data.data_gen import * #..This is for the data generation
...
# In this datamodule we use the indices to load the data, we need to restucture
# this to handle data raw.
class SequenceDataModule(pl.LightningDataModule):
    ...
    def __init__(
        self,
        dataset, #..I think we can repurpose it from here., the input is of the form [[vertex1],[vertex2],etc.]
        test_size: float,
        batch_points: int,
